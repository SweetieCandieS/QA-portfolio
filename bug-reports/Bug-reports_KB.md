...
1. Диалог с ботом: на вопрос о несуществующей услуге бот предлагает альтернативу и называет цену 900 ₽:
   ![Бот предлагает несуществующую услугу "проверка зрения" за 900 ₽](screenshots/screenshots_KB/br1-1-dialog.png)

2. Текст базы знаний партнёра — услуги "коррекция зрения" и "проверка зрения у офтальмолога" в базе отсутствуют:
   ![База знаний не содержит услуг по зрению](screenshots/screenshots_KB/br1-2-knowledge-base.png)

3. Список активных услуг в системе — подтверждает, что офтальмологических услуг в принципе нет:
   ![Список услуг партнёра без офтальмологии](screenshots/screenshots_KB/br1-3-services-list.png)
...
2. 
   ![Бот называет вымышленную цену 15000 ₸ и мастера "Марина Один"](screenshots/screenshots_KB/br2-1-dialog.png)

3. Поле «Текущий текст базы знаний» пустое — файл с ценами удалён, база знаний не содержит информации об услугах:
   ![База знаний пуста после удаления файла с ценами](screenshots/screenshots_KB/br2-2-empty-knowledge-base.png)

4. Список активных услуг в системе — цены на услуги не указаны:
   ![Список услуг без указанных цен](screenshots/screenshots_KB/br2-3-services-list.png)
...
1. Ошибка «Пустой ответ пайплайна» на запрос «Сколько стоит чистка зубов?»:
   ![Пустой ответ пайплайна при поиске по базе знаний](screenshots/screenshots_KB/br3-1-empty-pipeline.png)
...
2. Ошибка повторяется при разных формулировках запроса (в том числе после смены провайдера) — «Пустой ответ пайплайна» стабильно воспроизводится:
   ...
   ![Пустой ответ пайплайна повторяется на разных запросах](screenshots/screenshots_KB/br3-2-empty-pipeline-repeated.png)
